...
export const DEFAULT_GRAPHVIZ_FORM: GraphvizFormState = {
    ...
    pad: "0.3",
    margin: "0",
    bgcolor: DESIGN_TOKENS.colors.base.background,
    graphFontname: "Inter",
    graphFontsize: "11",
    nodeShape: "box",
    nodeStyle: "rounded,filled",
    nodeFillcolor: DESIGN_TOKENS.colors.gray[900],
    nodeColor: DESIGN_TOKENS.colors.gray[800],
    nodeFontcolor: DESIGN_TOKENS.colors.gray[300],
    nodeFontname: "Inter",
    nodeFontsize: "11",
    nodeWidth: "1.6",
    nodeHeight: "0.6",
    nodeMarginX: "0.12",
    nodeMarginY: "0.06",
    edgeColor: DESIGN_TOKENS.colors.gray[600],
    edgeFontname: "Inter",
    edgeFontsize: "9",
    edgePenwidth: "1",
    inheritanceStyle: "solid",
    inheritanceColor: DESIGN_TOKENS.colors.relationships.inheritance,
    associationColor: DESIGN_TOKENS.colors.relationships.association,
    instantiationColor: DESIGN_TOKENS.colors.relationships.instantiation,
    referenceColor: DESIGN_TOKENS.colors.relationships.reference,
