...
private:
    ...
    NormalizedToken parse_template_literal(TokenizerState& state);
    ...
    NormalizedToken parse_regex(TokenizerState& state);
    ...
    bool could_be_regex(TokenType last_type) const;
};
